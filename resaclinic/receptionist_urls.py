...
urlpatterns = [
        ...
        path('save_counsel/<int:patient_id>/<int:visit_id>/', ReceptionistView.save_counsel, name='receptionist_save_remote_counseling'),
        path('counseling_notes/<int:patient_id>/<int:visit_id>/', ReceptionistView.view_counseling_notes, name='receptionist_view_counseling_notes'),
