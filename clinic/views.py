...
from .models import AmbulanceActivity, AmbulanceOrder, AmbulanceRoute, AmbulanceVehicleOrder, Category, Company,  ConsultationNotes, ConsultationOrder, Country, Diagnosis,  Diagnosis, Equipment, EquipmentMaintenance,  HospitalVehicle, ImagingRecord, InventoryItem, LaboratoryOrder,  MedicineRoute, MedicineUnitMeasure, Order, PatientVisits, PatientVital, Prescription, PrescriptionFrequency, Procedure, Patients, QualityControl, Reagent, ReagentUsage, Referral, RemoteCompany,  Service, Supplier, UsageHistory
