...
from .models import AmbulanceOrder,   ConsultationOrder, DeductionOrganization, EmployeeDeduction, ImagingRecord, InventoryItem, LaboratoryOrder, Order, Prescription, Procedure, Reagent, ReagentUsage, RemotePrescription, SalaryChangeRecord, SalaryPayment, UsageHistory
