...
def generate_year_month_report(request):
    try:
        ...
        return render(request, 'kahama_template/generate_year_month_report.html', {'error': str(e)})

    except Exception as e:
        # Handle any other unexpected errors
        return render(request, 'kahama_template/generate_year_month_report.html', {'error': 'An unexpected error occurred: ' + str(e)})
