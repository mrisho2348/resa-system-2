...
class EditStaffProfileView(View):
    ...
    template_name = 'pembadoctor_template/edit_profile.html'
...
def doctor_profile(request):
    ...
    try:
        ...
        return render(request, 'pembadoctor_template/profile.html', {'staff': staff})

    except Staffs.DoesNotExist:
        return render(request, 'pembadoctor_template/profile.html', {'error': 'Doctor not found.'})
...
def change_password(request):
    ...
    return render(request, 'pembadoctor_template/change_password.html', {'form': form})
...
def kahama_dashboard(request):
    ...
    return render(request, "pembadoctor_template/home_content.html", context)
...
def search_report(request):
    if request.method == 'POST' and request.META.get('HTTP_X_REQUESTED_WITH') == 'XMLHttpRequest':
        ...
        report_templates = {
            'patient_type_reports': 'pembadoctor_template/patient_type_report_table.html',
            'patient_company_wise_reports': 'pembadoctor_template/company_wise_reports_table.html',
            'patient_lab_result_reports': 'pembadoctor_template/laboratory_report_table.html',
            'patient_procedure_reports': 'pembadoctor_template/procedure_report_table.html',
            'patient_referral_reports': 'pembadoctor_template/referral_reports_table.html',
            'patient_pathology_reports': 'pembadoctor_template/pathology_record_report_table.html',
        }
...
def render_report(report_type, year):
    if report_type == 'patient_type_reports':       
        ...
        return render_to_string('pembadoctor_template/pathology_record_report_table.html',context)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect('pemba_doctor_generate_year_month_report')

        else:
            messages.error(request, "Form validation failed. Please correct the errors below.")
            return render(request, 'pembadoctor_template/generate_year_month_report.html', {'form': form})
...
def appointment_list_view(request):
    ...
    return render(request, 'pembadoctor_template/manage_appointment.html', context)
...
def confirm_meeting(request, appointment_id):
    ...
    return redirect('pemba_doctor_appointment_list')
    ...
    if request.method == 'POST':
        try:
            ...
            if doctor_plan == "Laboratory":
                return redirect(reverse('pemba_doctor_laboratory_save', args=[patient_id, visit_id]))
            else:
                return redirect(reverse('pemba_doctor_consultation_save_next', args=[patient_id, visit_id]))
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if doctor_plan == 'Prescription':
                return redirect(reverse('pemba_doctor_prescription_save', args=[patient_id, visit_id]))
                ...
                return redirect(reverse('pemba_doctor_referral_save', args=[patient_id, visit_id]))
            elif doctor_plan == 'Counselling':
                return redirect(reverse('pemba_doctor_counseling_save', args=[patient_id, visit_id]))
            elif doctor_plan == 'Procedure':
                return redirect(reverse('pemba_doctor_procedure_save', args=[patient_id, visit_id]))
            elif doctor_plan == 'Observation':
                return redirect(reverse('pemba_doctor_save_observation', args=[patient_id, visit_id]))
            elif doctor_plan == 'Discharge':
                return redirect(reverse('pemba_doctor_discharge_save', args=[patient_id, visit_id]))
        ...
        return render(request, 'pembadoctor_template/add_patientprovisional_diagnosis.html', context)
...
def download_consultation_summary_pdf(request, patient_id, visit_id):
    ...
    html_content = render_to_string('pembadoctor_template/pdf_consultation_summary.html', context)
...
def save_counsel(request, patient_id, visit_id):
    ...
    return render(request, 'pembadoctor_template/counsel_template.html', context)
...
def download_counseling_pdf(request, patient_id, visit_id):
    ...
    html_content = render_to_string('pembadoctor_template/counseling_notes_details.html', context)
    temp_dir = os.path.join(os.path.expanduser("~"), "pdf_temp")
    os.makedirs(temp_dir, exist_ok=True)
...
def download_discharge_pdf(request, patient_id, visit_id):
    ...
    html_content = render_to_string('pembadoctor_template/discharge_note_detail.html', context)
    temp_dir = os.path.join(os.path.expanduser("~"), "pdf_temp")
    os.makedirs(temp_dir, exist_ok=True)
...
def save_laboratory(request, patient_id, visit_id):
    ...
    return render(request, 'pembadoctor_template/laboratory_template.html', context)
...
def patient_lab_result_history_view(request, mrn):
    ...
    return render(request, 'pembadoctor_template/manage_patient_lab_result.html', context)
...
def download_lab_result_pdf(request, lab_id):
    ...
    html_content = render_to_string('pembadoctor_template/pdf_lab_result.html', context)
...
def download_all_lab_results_pdf(request, patient_mrn, visit_vst):
    ...
    html_content = render_to_string('pembadoctor_template/pdf_all_lab_results.html', context)
...
def edit_lab_result(request, patient_id, visit_id, lab_id):
    ...
    if request.method == 'POST':        
        ...
        return redirect(reverse('pemba_doctor_patient_lab_result_history_view', args=[patient.mrn]))
    ...
    context['form'] = form    
    return render(request, 'pembadoctor_template/edit_lab_result.html', context)
...
def download_observation_pdf(request, patient_id, visit_id):
    ...
    # Render HTML template
    html_content = render_to_string('pembadoctor_template/observation_notes_detail.html', context)
...
def patient_info_form(request):
    ...
    if request.method == 'POST':
        try:
            ...
            return redirect(reverse('pemba_doctor_patient_health_info', args=[patient.id]))
    ...
    return render(request, 'pembadoctor_template/add_remotePatients.html', context)
    ...
    if request.method == 'POST':
        try:
            ...
            if 'save_back' in request.POST:
                return redirect('pemba_doctor_patients_list')
            elif 'save_continue_health' in request.POST:
                return redirect(reverse('pemba_doctor_patient_health_edit', args=[patient_id]))
...
def health_info_edit(request, patient_id):
    ...
    try:
        ...
        return render(request, 'pembadoctor_template/edit_patient_health_condition_form.html', context)
...
def save_patient_health_information(request, patient_id):
    ...
    return render(request, 'pembadoctor_template/add_patient_health_condition_form.html', {'patient': patient, 'all_medicines': all_medicines})
...
def save_prescription(request, patient_id, visit_id):
    ...
    try:
        ...
        return render(request, 'pembadoctor_template/prescription_template.html', {           
            'patient': patient,
            'visit': visit,       
            'consultation_notes': consultation_notes,       
            'medicines': medicines,        
...
def prescription_list(request):
    ...
    return render(request, 'pembadoctor_template/manage_prescription_list.html', {
...
def download_prescription_notes_pdf(request, patient_id, visit_id):
    ...
    html_content = render_to_string('pembadoctor_template/prescription_notes.html', context)
    ...
    try:
        if request.method == 'POST':
            ...
            if not names or not descriptions:
                messages.error(request, 'Please fill out all required fields.')
                return render(request, 'pembadoctor_template/procedure_template.html', context)
...
def patient_procedure_view(request):
    ...
    return render(request, 'pembadoctor_template/manage_procedure.html', context)
...
def patient_procedure_history_view(request, mrn):
    ...
    return render(request, 'pembadoctor_template/manage_patient_procedure.html', context)
...
def download_procedure_result_pdf(request, procedure_id):
    ...
    html_content = render_to_string('pembadoctor_template/pdf_procedure_result.html', context)
    temp_dir = os.path.join(os.path.expanduser("~"), "pdf_temp")
    os.makedirs(temp_dir, exist_ok=True)
...
def download_all_procedures_pdf(request, patient_mrn, visit_vst):
    ...
    html_content = render_to_string('pembadoctor_template/pdf_all_procedures.html', context)
...
def download_referral_pdf(request, patient_id, visit_id):
    ...
    html_content = render_to_string('pembadoctor_template/view_referral.html', context)
    temp_dir = os.path.join(os.path.expanduser("~"), "pdf_temp")
    os.makedirs(temp_dir, exist_ok=True)
...
def reports_comprehensive(request):
    ...
    return render(request, 'pembadoctor_template/reports_comprehensive.html', context)
...
def reports_service(request):
    ...
    return render(request, "pembadoctor_template/reports_service.html")


@login_required
def reports_stock_level(request):
    """View for stock level reports"""
    return render(request, "pembadoctor_template/reports_stock_level.html")
...
def resa_report(request):
    ...
    return render(request, "pembadoctor_template/resa_reports.html", context) 
...
def save_patient_visit_save(request, patient_id, visit_id=None):
    ...
    if request.method == 'POST':
        try:
            ...
            return redirect(reverse('pemba_doctor_vitals_save', args=[patient_id, visit.id]))
            ...
            return render(request, 'pembadoctor_template/add_patient_visit.html', {'patient': patient, 'visit': None})
        ...
        return render(request, 'pembadoctor_template/add_patient_visit.html', {'patient': patient, 'visit': visit})
...
def reports_by_visit(request):
    ...
    return render(request, 'pembadoctor_template/reports_by_visit.html', context)
...
def save_remotepatient_vitals(request, patient_id, visit_id):
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            return render(request, 'pembadoctor_template/add_remotepatient_vital.html', context)
